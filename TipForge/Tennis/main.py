...
from analysis import get_betting_statistics
...
if '-' in date:
    ...
    print("❌ Adatgyűjtés kihagyva.")


# BETTING FRISSÍTÉS
if input("\nEredmények frissítéséhez írd be, hogy 'friss'.\n") == "friss":
...
# BETTING ELEMZÉSE
if input("\nFogadások elemzéséhez írd be, hogy 'elemez'.\n") == "elemez":
    print(get_betting_statistics())
else:
    print("❌ Elemzés kihagyva.")