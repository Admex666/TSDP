...
Használat: python prediction_example_20251018_122833.py
"""
...
with open('models/logistic_regression_csgo_20251018_122833.pkl', 'rb') as f:
    model = pickle.load(f)

with open('models/full_pipeline_20251018_122833.pkl', 'rb') as f:
