...
[r2_xgdpts, b0_xgdpts, b1_xgdpts] = fbr.fbref_linreg(df_table.xGD, df_table.Pts)
df_table['reg_xPts'] = b0_xgdpts + df_table['xGD'] * b1_xgdpts 
df_table['reg_xPts_diff'] = df_table.Pts - df_table.reg_xPts

#%% Exporting to excel
df_table.to_excel(r'C:\TwitterSportsDataProject\fbref scrapes\fbref_GD-Pts_reg.xlsx', index=False)
