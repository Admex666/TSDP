...
#%% Positional weights
positional_weights = {
    'Ball_Playing_Defender': default['DF'].copy(),
    'Deep_Lying_Playmaker': default['MF'].copy(),
    'Ball_Winning_Midfielder': default['MF'].copy(),
    'Inside_Forward': default['FW'].copy(),
    'Poacher': default['FW'].copy(),
    'Sweeper_Keeper': default['GK'].copy()
}

# Ball Playing Defender – magasabb passz-, technika- és vonalbontó képesség:
positional_weights['Ball_Playing_Defender'].update({
    'Total_Cmp': 1.3,
    'Total_Cmp%': 1.1,
    'Long_Cmp%': 1.2,
    'Carries_PrgDist': 1.3,
...
positional_weights['Deep_Lying_Playmaker'].update({
    'Total_Cmp%': 1.5,
    'PrgP': 1.4,
    'KP': 1.3,
    'SCA_SCA90': 1.2,
...
positional_weights['Ball_Winning_Midfielder'].update({
    'Tackles_Tkl': 1.6,
    'Challenges_Tkl%': 1.5,
    'Tkl+Int': 1.4,
    'Performance_Int': 1.4,
...
positional_weights['Inside_Forward'].update({
    'Performance_Gls': 1.7,
    'Expected_npxG': 1.6,
    'Progression_PrgR': 1.1,
    'Take-Ons_Succ': 1.2,
    'Performance_SoT': 1.3,
    'Ast': 1.1,
    'Receiving_Rec': 1.0
...
positional_weights['Sweeper_Keeper'].update({
...
position_or_tactic = 'p'
if position_or_tactic == 'p':
    weight_dict = positional_weights[role]
else:
    weight_dict = tweights[tactic][pos]
