        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="grid md:grid-cols-3 gap-6 mb-12">
            ...
            <div className="p-6 bg-[#121212] rounded-xl border border-[#2A2A2A]">
              ...
              <p className="text-sm text-[#A9A9A9]">2.990 Ft/hó (normál: 4.990 Ft)</p>
            </div>
            <div className="p-6 bg-[#121212] rounded-xl border border-[#2A2A2A]">
              <div className="text-3xl mb-3">🎁</div>
              <h3 className="font-semibold mb-2">Ajándék guide</h3>
              <p className="text-sm text-[#A9A9A9]">Bankroll management (ér 9.990 Ft)</p>
            </div>
          </div>
      ...
      {showExitPopup && (
        <div className="fixed inset-0 bg-black/80 flex items-center justify-center z-50 p-6">
          <div className="bg-[#1E1E1E] rounded-xl max-w-md w-full p-8 relative border border-[#2A2A2A]">
            ...
            <h3 className="text-2xl font-bold mb-4">⚠️ Várj, mielőtt elmész!</h3>
            ...
            <ul className="space-y-2 mb-6">
              <li className="flex items-start gap-2">
                ...
                <span className="text-[#A9A9A9]">-40% launch árazást (2.990 Ft helyett 4.990 Ft lesz)</span>
              </li>
              <li className="flex items-start gap-2">
                <span className="text-[#FF6B35] mt-1">❌</span>
...
export default TipForgeLanding;